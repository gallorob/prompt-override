...
class LLMSetting(BaseSettings):
    ...
    prompt: str = Field(default='./assets/karma_prompt', description='The system prompt to use.')
...
class Settings(BaseSettings):
    title: str = Field(default='./assets/title.txt', description='The location of the title ASCII art.')
