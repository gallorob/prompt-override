...
from textual.containers import ScrollableContainer, Center, Horizontal
...
class IntroScreen(Screen):
	def __init__(self, level: Level):
		...
		with open(os.path.join(settings.assets_dir, f'level{str(self.level.number).zfill(2)}', 'intro'), 'r') as f:
