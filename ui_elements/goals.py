...
from textual.containers import Center, VerticalScroll, Container
from textual.screen import Screen
from textual.widgets import Checkbox, Static, Button, Footer
...
class GoalsDisplay(ModalScreen):
    ...
    def compose(self) -> ComposeResult:
        ...
        if hasattr(self, 'timer') and self.timer:
            self.timer.stop()
            btn = self.game_screen.query_exactly_one(selector='#objectives_button', expect_type=Button)
